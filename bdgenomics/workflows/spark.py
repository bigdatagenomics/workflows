...
class SparkService(Job.Service):
    ...
    def start(self, job):
        ...
        self.sparkContainerID = dockerCheckOutput(job=job,
                                                  defer=STOP,
                                                  workDir=os.getcwd(),
                                                  tool="quay.io/ucsc_cgl/apache-spark-master:2.1.1--acd08bd3e5670502636fb6842b777eb2aff6def7",
        ...
        self.hdfsContainerID = dockerCheckOutput(job=job,
                                           defer=STOP,
                                           workDir=os.getcwd(),
                                           tool="quay.io/ucsc_cgl/apache-hadoop-master:2.7.4--9a9cdee76b65a50e63ad2ca8f9db6da2bd11965c",
                                           dockerParameters=["--net=host",
                                                              "-d"],
                                           parameters=[self.hostname])[:-1]
...
class WorkerService(Job.Service):
    ...
    def start(self, job):
        ...
        self.sparkContainerID = dockerCheckOutput(job=job,
                                                  defer=STOP,
                                                  workDir=os.getcwd(),
                                                  tool="quay.io/ucsc_cgl/apache-spark-worker:2.1.1--acd08bd3e5670502636fb6842b777eb2aff6def7",
                                                  dockerParameters=["--net=host",
                                                                    "-d",
                                                                    "-v", "/mnt/ephemeral/:/ephemeral/:rw",
                                                                    "-e",
    ...
    def __start_datanode(self, job):
        ...
        self.hdfsContainerID = dockerCheckOutput(job=job,
                                                 defer=STOP,
                                                 workDir=os.getcwd(),
                                                 tool="quay.io/ucsc_cgl/apache-hadoop-worker:2.7.4--9a9cdee76b65a50e63ad2ca8f9db6da2bd11965c",
                                                 dockerParameters=["--net=host",
                                                                    "-d",
                                                                    "-v", "/mnt/ephemeral/:/ephemeral/:rw"],
